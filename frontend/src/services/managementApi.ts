...
export type StaffMember = { id: string; name: string; email: string; phone: string | null; status: string; branchIds: string[]; branchNames: string[]; lastLoginAt: string | null; roles?: string[] }
...
export type CreateStaffInput = { firstName: string; lastName: string; email: string; phone?: string; password?: string; branchIds: string[]; role?: 'staff' | 'manager' }
export type UpdateStaffInput = { firstName: string; lastName: string; email: string; phone?: string; password?: string; branchIds: string[]; role?: 'staff' | 'manager'; active?: boolean }
...
export const managerApi = {
  dashboard: staffApi.dashboard,
  orders: staffApi.orders,
  products: staffApi.products,
  branches: staffApi.branches,
  adjustInventory: staffApi.adjustInventory,
  users: staffApi.users,
  tableZones: adminApi.tableZones,
  tableFeatures: adminApi.tableFeatures,
  tables: adminApi.tables,
  createTable: adminApi.createTable,
  updateTable: adminApi.updateTable,
  deactivateTable: adminApi.deactivateTable,
}
