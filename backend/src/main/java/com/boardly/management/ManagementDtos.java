...
public final class ManagementDtos {
    ...
    public record StaffResponse(UUID id, String name, String email, String phone, String status, List<UUID> branchIds, List<String> branchNames, OffsetDateTime lastLoginAt, List<String> roles) {}
    public record CreateStaffRequest(@NotBlank @Size(max = 100) String firstName, @NotBlank @Size(max = 100) String lastName, @Size(max = 100) String displayName, @NotBlank @Email String email, @Size(max = 30) String phone, @NotBlank @Size(min = 12, max = 128) String password, @NotEmpty List<UUID> branchIds, @NotNull UUID primaryBranchId, String role) {}
    public record UpdateStaffRequest(@NotBlank @Size(max = 100) String firstName, @NotBlank @Size(max = 100) String lastName, @Size(max = 100) String displayName, @Size(max = 30) String phone, @NotBlank String status, @NotEmpty List<UUID> branchIds, @NotNull UUID primaryBranchId, String role) {}
